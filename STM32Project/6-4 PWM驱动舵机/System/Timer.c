...
//	TIM_InternalClockConfig(TIM2);
	...
	TIM_TimeBaseInitStructure.TIM_Period = 10 - 1;		//ARR			//定时器溢出频率
	TIM_TimeBaseInitStructure.TIM_Prescaler = 1 - 1;	//PSC					//预分频和自动重装设置
...
//	TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_High;					//设置输出比较属性
//	TIM_OCInitStructure.TIM_OutputNState = TIM_OutputNState_Enable; 				//设置输出比较极性
//	TIM_OCInitStructure.TIM_Pulse = 50;			//CCR占空比			//设置输出使能
